...
O propósito desta página consiste em arquivar os elementos pertinentes à oitava apresentação, abrangendo desde o vídeo da própria apresentação 
...
<p style="text-align: center"><a href="https://youtu.be/Urrd0P5xgR4" target="blanket">Vídeo apresentação 8</a></p>
...
--------- | ------ | ------ | ---------- | ----------
|`1.0` | 22/11/2023| Criação da página de apresentação 8 |[Breno Queiroz](https://github.com/brenob6) |[Luis Miranda](https://github.com/mayara-tech) |
