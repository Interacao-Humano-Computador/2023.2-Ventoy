# Verificação Relato dos Resultados do Protótipo "Verificação Criar Post no Fórum"
...
| 5  | Todas as tabelas e imagens são chamadas no texto, possuem legendas e fontes?                                                   | Incompleto | A primeira tabela não está sendo chamada no texto.|
...
Documentar melhor como a entrevista ocorreu explicitando como o usuário interagiu com o sistema apresentado, apresentar os feedbacks que o usuário teve do protótipo e se atentar alguns detalhes da contrução do texto como as tabelas.
...
Como apresentado no [planejamento](), para o retrabalho oautor do artefato [Breno Queiroz](https://github.com/brenob6.png) que irá fazer as correções dos problemas apresentados pela verificação. O responsável por essa verificação fará uma revisão das correções feitas, checando se as correções são suficientes e se foi introduzido novos erros ou não. A tabela 3 a seguir apresenta o cronograma de correções.
...
| :--------------: | :------------------------------------------- | :--------------------------------------------: | :-----------------------------------------: | :--------------: |
|    05/12/2023    | Corrigir erros encontrados pela verificação  | [Breno Queiroz](https://github.com/brenob6.png) | [Limirio Guimarães](https://github.com/LimirioGuimaraes)|  |
