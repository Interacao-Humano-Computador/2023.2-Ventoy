...
| 2  | O artefato possui Metodologia? | Não Conforme | - |
| 3  | O artefato artefato possui uma Bibliografia/Referência Bibliográfica? |Conforme | - |
| 4  | O artefato possui um Histórico de Versões com o id e descrição das versões, data, autores e revisores? | Conforme  | - |
| 5  | Os revisores são pessoas diferentes dos autores?  | Conforme | -  |
| 6  | Todas as tabelas e imagens são chamadas no texto, possuem legendas e fonte | Não se aplica | -  |
| 7  | Os cenários possuem um enredo que contém sequências de ações e eventos? (O que os usuários fazem, o que acontece com eles) | Conforme | - |
| 8  | Os cenários possuem um título que descreve com clareza a situação? |Conforme| - |
| 9  | Os cenários possuem elementos de ambiente ou contexto? (descrições da situação que motivaram ou explicam os objetivos dos atores) | Conforme | - |
| 10 | Os cenários possuem elementos como atores? (Pessoas que irão interagir com o ambiente) | Conforme | - |
| 11 | Os cenários possuem elementos como objetivos? (Efeitos que motivaram as ações realizadas dos atores)  | Conforme | - |
| 12 | Os cenários possuem um planejamento? (Segmento de uma atividade mental para alcançar um objetivo) | Conforme | - |
| 13 | Os cenários possuem ações? (Os atores possuem comportamentos visíveis) | Conforme | - |
| 14 | Os cenários possuem eventos? (Ações externas ou reações produzidas pelo ambiente) | Conforme | - |
| 15 | Os cenários possuem elementos como recursos? | Conforme | - |
| 16 | Os cenários possuem restrições? | Conforme | - |
| 17 | Os cenários possuem exceções? | Não Conforme | - |
| 19 | Os cenários possuem uma conclusão? | Incompleto | O cenário 3 não possui conclusão. |
| 20 | Foi descrito as características pessoais dos atores, que sejam relevantes ao cenário? | Conforme | - |
| 21 | Foi utilizado as personas para definir os atores do cenário? | Conforme | - |
...
Uma explicação mais detalhada de como os cenários foram desenvolvidos podem agregar ao artefato, o cenário 3 também pode ser melhor descrtito.
...
![Gráfico percentual de respostas](../..//assets/verificacao-liro/pizza-cenarios.png)
...
- 17/21 exigências são atendidas (Conformes);
- 1/21 exigências estão incompletas;
- 2/21 exigências estão erradas ou não foram realizadas (Não conformes).
- 1/21 não se aplica.

Onde 21 é a quantidade de itens avaliados na verificação.

Portanto, com base no cálculo apresentado, pode-se dizer que o aproveitamento deste artefato está em 78,54%.
