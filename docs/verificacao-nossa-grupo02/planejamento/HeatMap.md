...
Como apresentado no [planejamento](), para o retrabalho o autor do artefato [Limirio Guimarães](https://github.com/LimirioGuimaraes) que vai fazer as correções dos problemas apresentados pela verificação. O responsável por essa verificação fará uma revisão das correções feitas, checando se as correções são suficientes e se foi introduzido novos erros ou não. A tabela 7 a seguir apresenta o cronograma de correções.
