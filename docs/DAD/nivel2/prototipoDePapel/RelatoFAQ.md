...
Apesar do bom retorno da avaliação sobre o protótipo de papel ao analisar a estrutura e o design da página de FAQ, notamos uma discrepância em relação ao padrão adotado nas demais páginas do site. A uniformidade na apresentação é crucial para a compreensão efetiva e a navegação fluida pelos conteúdos oferecidos. A inconsistência observada motivou a decisão de realizar um retrabalho cuidadoso e minucioso no design da página de FAQ. Desta forma foi elaborado um novo cronograma, que pode ser observado na tabela 4.

<center>

**Tabela 04**: Cronograma de retrabalho

| Descrição                                      | Data                         |
| ------------------------------------------------------------------------- | ------------------------------------ |
| Redesign da interface da página do FAQ                   | 23/11/2023                       |
| Construção do novo protótipo de papel                        | 24/11/2023                       |
| Realização do teste piloto                  | 26/11/2023                         |
| Realização da avaliação do protótipo de papel                      | 26/11/2023                         |
| Consolidação dos resultados                     | 02/12/2023                       |

Fonte: [Mayara Alves](https://github.com/Mayara-tech)

</center>

### Novo protótipo de papel

Como definido no retrabalho, foi realizado um novo design para página de FAQ com intuito de garantir uma experiência mais coesa e harmoniosa para os usuários com as demais páginas do Ventoy. Na figura 1 e 2 podemos observar o novo design da página de FAQ
...
### Avaliação do novo protótipo de papel

A avaliação seguiu os mesmos parametros da primeira avaliação com o mesmo participante da primeira avaliação, na tabela 5 podemos observar o cronograma executada desta segunda avaliação.
<center>

**Tabela 5** - Cronograma Executado do novo protótipo de papel
...
Foi apresentado ao usuário o novo design do protótipo de papel, que durante toda a avaliação, ele tinha autonomia para sugerir melhorias e alterar características da interface em que estava trabalhando. No entanto, durante o uso, o usuário não apontou nenhuma característica que deveria ser introduzida, alterada ou removida. Para estimular melhores resultados e de acordo com o [planejamento da avaliação do protótipo de papel](./planejamento_avaliacao.md), algumas perguntas foram realizadas ao usuário. As respostas a essas perguntas podem ser visualizadas na tabela 6.

<center>

**Tabela 06**: Tabela de resultados das perguntas feitas ao usuário no retrabalho.
