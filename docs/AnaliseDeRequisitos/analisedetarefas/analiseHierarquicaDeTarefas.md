...
|1. Acessar a página de doações |**Plano:** Acessar a página de doações no site do ventoy. **Feedback:** Garantir que os usuários encontrem facilmente o link para a aba de doações.<br/> |
...
|`2.1`| 20/10/2023 | Adicionado representação HTA em tabela da figura 5 | [Limirio Guimarães](https://github.com/LimirioGuimaraes)| |
